$(document).ready(function() {
  ...
  var menuOpenIcon = $(".nav__icon-menu"),
    ...
    searchOpenIcon = $(".nav__icon-searching"),
    searchCloseIcon = $(".searching__close"),
    searchInput = $(".searching__text"),
    searchBox = $(".search");
  ...
  $('.searching, .searching__box').on('click keyup', function (event) {
    if (event.target == this || event.keyCode == 27) {
      $('.searching').removeClass('is-visible');
    }
  });
  ...
  // =====================
  SimpleJekyllSearch({
    searchInput: document.getElementById("js-searching-input"),
